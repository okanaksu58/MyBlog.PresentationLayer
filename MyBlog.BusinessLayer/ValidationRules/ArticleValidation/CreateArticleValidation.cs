...
namespace MyBlog.BusinessLayer.ValidationRules.ArticleValidation
{
    public class CreateArticleValidation : AbstractValidator<Article>
    {
        ...
        {
            RuleFor(x => x.Title).NotEmpty().WithMessage("Lütfen Başlığı Boş Geçmeyiniz").MinimumLength(5).WithMessage("Lütfen en az 5 karakter veri girişi yapınız").MaximumLength(100).WithMessage("Lütfen en fazla 100 karakter girişi yapınız");
